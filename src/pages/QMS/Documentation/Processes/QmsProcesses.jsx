  ...
  return (
    <div className="bg-[#1C1C24] text-white p-5 rounded-lg">
      <div className="flex justify-between items-center mb-5">
        <h1 className="processes-head">Processes</h1>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-[#24242D]">
                <tr className="h-[48px]">
                  <th className="px-4 qms-processes-thead text-left">No</th>
                  <th className="px-4 qms-processes-thead text-left">Name</th>
                  <th className="px-4 qms-processes-thead text-left">No</th>
                  <th className="px-4 qms-processes-thead text-left">Type</th>
                  <th className="px-4 qms-processes-thead text-left">Date</th>
               
                  
                  <th className="px-4 qms-processes-thead text-center">View</th>
                  <th className="px-4 qms-processes-thead text-center">Edit</th>
                  <th className="px-4 qms-processes-thead text-center">Delete</th>
                </tr>
              </thead>
              <tbody>
                {currentRecords.map((item, index) => (
                  <tr key={item.id} className="border-b border-[#2D2D35] h-[48px]">
                    ...
                    <td className="px-4 qms-processes-data">{item.name}</td>
                    <td className="px-4 qms-processes-data">{item.no || 'N/A'}</td>
                    <td className="px-4 qms-processes-data">{item.type}</td>
                    <td className="px-4 qms-processes-data">{formatDate(item.created_at)}</td>
                   
              
                    <td className="px-4 qms-processes-data text-center">
