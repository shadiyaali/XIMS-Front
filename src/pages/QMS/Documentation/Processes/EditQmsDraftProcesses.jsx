            ...
            <div className="flex flex-col gap-4 mt-2">
              <div className="flex items-center">
                <input
                  ...
                  onChange={handleInputChange}
                />
                <label htmlFor="is_draft" className="add-qms-manual-label">Save as Draft</label>
              </div>
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={handleInputChange}
                />
                <label htmlFor="send_notification" className="add-qms-manual-label">Send Notification</label>
              </div>
            </div>
          </div>
